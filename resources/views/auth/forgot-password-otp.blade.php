...
@section('content')
    <section class="panel mx-auto max-w-xl p-8">
        <p class="text-xs font-semibold uppercase tracking-[0.34em] text-amber-600">OTP Reset Password</p>
        ...
        <div class="mt-5 text-center text-sm text-slate-600">
            <a href="{{ route('password.request') }}" class="font-semibold text-slate-950 underline underline-offset-4">Kembali ke lupa password</a>
        </div>
    </section>
@endsection
